...
#pragma warning restore 649
        ...
        private CurvyControllerState state = CurvyControllerState.Stopped;
        ...
        /// <summary>
        /// When <see cref="OrientationMode"/> is None, and <see cref="LockRotation"/> is true, this field is the value of the locked rotation
        /// </summary>
        ...
        /// </summary>
        private float editModeLastUpdate;
#endif
        ...
        protected virtual void InitializedApplyDeltaTime(float deltaTime)
        {
            ...
            {
                float speed = OffsetCompensation
        ...
        protected virtual void ComputeTargetPositionAndRotation(out Vector3 targetPosition, out Vector3 targetUp, out Vector3 targetForward)
        {
            ...
            targetPosition = ApplyOffset(pos, tangent, orientation, OffsetAngle, OffsetRadius);
        }
        ...
        static Vector3 ApplyOffset(Vector3 pos, Vector3 tan, Vector3 up, float angle, float radius)
        {
        ...
        private float ComputeOffsetCompensatedSpeed(float deltaTime)
        {
            ...
            if (OrientationMode == OrientationModeEnum.None || CurvyUtility.Approximately(OffsetRadius, 0))
                return Speed;
